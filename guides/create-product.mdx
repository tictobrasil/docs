---
title: "Como criar um produto na Ticto via API"
sidebarTitle: "Criar Produto"
description: "Guia completo para criar cursos, ebooks, assinaturas e outros tipos de produto na Ticto usando a API v2."
---

A API v2 da Ticto permite que você crie e gerencie produtos de forma programática, integrando sua plataforma diretamente ao seu fluxo de desenvolvimento ou ferramentas de automação. Com um único endpoint, você registra cursos, ebooks, assinaturas e muito mais — sem precisar acessar o painel para cada cadastro.
...
| `subscription` | Assinatura recorrente (SaaS, clube)          |
| `software`     | Software ou aplicativo digital               |
| `physical`     | Produto físico com entrega                   |

## Criando um produto digital

<Steps>
  <Step title="Prepare o payload">
    Monte o corpo da requisição com o nome e o tipo do produto. Para produtos digitais, apenas esses campos básicos são necessários — o **Preset Resolver** da Ticto configura automaticamente os métodos de pagamento e outras opções.
...
<ParamField body="type" type="string" required>
  Tipo do produto. Valores aceitos: `course`, `ebook`, `subscription`, `software`, `physical`. Define as configurações padrão aplicadas automaticamente pelo Preset Resolver.
</ParamField>

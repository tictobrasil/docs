---
title: "Como criar um produto na Ticto usando a API v2"
...
<ParamField body="type" type="string" required>
  Tipo do produto. Valores aceitos: `course`, `ebook`, `subscription`, `software`, `physical`. Define as configurações padrão aplicadas automaticamente pela Ticto.
</ParamField>

...
<Note>
  Tokens com prefixo `ticto_test_` apontam para o ambiente sandbox (`https://sandbox.ticto.cloud/api/v2`). Produtos e ofertas criados no sandbox são rascunhos descartáveis e **nunca geram cobranças reais**. Use-os à vontade para testar integrações, validar payloads e simular fluxos sem nenhum risco financeiro.
</Note>

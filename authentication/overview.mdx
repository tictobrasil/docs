---
title: "Autentique requisições na Ticto API"
sidebarTitle: "Visão Geral"
description: "Aprenda a gerar e usar tokens de API para autenticar suas requisições à Ticto API v2 com segurança."
---
...
```bash
curl https://api.ticto.com.br/v2/products \

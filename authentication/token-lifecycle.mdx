---
title: "Ciclo de vida do token da Ticto API"
sidebarTitle: "Ciclo de Vida"
description: "Entenda como criar, revogar e rotacionar tokens da Ticto API v2 para manter sua integração segura."
---
...
Ao criar um token, você pode definir uma **data de expiração** (`expires_at`). Quando essa data é atingida, o token expira automaticamente e todas as requisições que o utilizarem passam a retornar `401 Unauthorized`.
